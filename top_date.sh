...
# =================================================
# top_date - Monitor de Fechas en tiempo real
# =================================================
# Muestra un histograma vivo de las fechas
...
TEMP_FILE=$(mktemp /tmp/nginx_date_XXXXXX.tmp)
REFRESH_INTERVAL=1
TOP_N=30
...
# Mensaje inicial
echo -e "${GREEN}Iniciando monitor de Fechas...${NC}"
