...
# =================================================
# top_status - Monitor de Status Codes en tiempo real
# =================================================
# Muestra un histograma vivo de los códigos de respuesta
# HTTP más frecuentes en el log de Nginx
#
# Uso: top_status
...
TEMP_FILE=$(mktemp /tmp/nginx_status_XXXXXX.tmp)
REFRESH_INTERVAL=1
TOP_N=30
